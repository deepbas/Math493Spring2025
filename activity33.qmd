...
```{webr}
gg_tsresiduals(sydney_models %>% select(ETS_ANA))
gg_tsresiduals(sydney_models %>% select(ETS_AAA))
gg_tsresiduals(sydney_models %>% select(ARIMA))
gg_tsresiduals(sydney_models %>% select(ETS_WAVE))
gg_tsresiduals(sydney_models %>% select(ETS_Ensemble))
```
