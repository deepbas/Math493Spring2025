...
2. **Exponential Smoothing**:
   ...
   - Extensions like Holt-Winters methods adapt to trends and seasonality, making it useful for forecasting.
...
stock_ts %>%
  ...
  labs(title = "Smoothing Techniques Applied to Apple Inc. Adjusted Closing Price",
       subtitle = "Original Series (Black), Moving Average (Blue), Holt-Winters (Red)",
